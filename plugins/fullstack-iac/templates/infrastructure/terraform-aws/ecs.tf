...
# =============================================================================
# Description: ECS cluster, task definitions, and services with auto-scaling
# Best Practices: Fargate, multi-AZ, health checks, auto-scaling
# =============================================================================
...
# Custom policy for task permissions (S3, SES, etc.)
